    ...
    <VerticalTimeline className="k-overflow" layout="1-column">
      ...
      <VerticalTimelineElement
        ...
        icon={
          <img
            className="vertical-timeline-element-icon bounce-in"
            src="https://media-exp1.licdn.com/dms/image/C4E0BAQFGFNmrO7AKNg/company-logo_200_200/0/1553536363764?e=1629936000&v=beta&t=M3kom4STSrJpbiCZtIWPXQ1vr8pVje7JsqAmyPV0tHc"
            alt="Google logo"
            height={55}
          />
        }
